...
#pragma warning disable 1591
    public static class StringExtensions
    {
       ...
       public static string CastToString(this byte[] buff)
       {
        ...
        public static string GetWebFilename(this string fullWebPath)
        {
            var arr = fullWebPath.Split("/".ToCharArray());
            return arr.Last();
        }

        public static string RemoveWebFilename(this string absoluteURI)
        {

            return absoluteURI.Substring(0, absoluteURI.LastIndexOf("/"));
        }

        public static string ConcatenateWebPaths(this string path1, string path2)
        {
        ...
        public static string ConcatenateFilePaths(this string path1, string path2)
        {
            if (path1 == null || path2 == null) return null;
            if (path2.StartsWith(@"\"))
                path2 = path2.Substring(1, path2.Length - 1);
        ...
        public static bool SameAsCurrentFTPDirectory(this string path1, string path2)
        {
            path2 = path2.ConcatenateWebPaths("/");
            return path2.LastIndexOf(path1) >= 0;
        }
        ...
        public static string Combine(this string[] array, string delim)
        {
            return string.Join(delim, array);
        }

        public static bool ShouldBeEmptyOrNull(this string[] arr)
        {
